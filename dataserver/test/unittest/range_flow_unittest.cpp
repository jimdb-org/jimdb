...
TEST_F(SelectFlowTest, SelectFlowAndAgg) {
    ...
    { // put data
        ...
        for (auto id = 0; id < data_count; id++) {
            ...
            // make encode key
            EncodeKeyPrefix(&key, default_account_table_id); // key:00000001 ("\x01"+"00000001")
            for ( auto & col : ptr_table_account->GetPKs()) {
