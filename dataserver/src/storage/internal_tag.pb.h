...
class InternalTag : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:jim.ds.storage.pb.InternalTag) */ {
 public:
  InternalTag();
  virtual ~InternalTag();
  ...
  // @@protoc_insertion_point(class_scope:jim.ds.storage.pb.InternalTag)
 private:
