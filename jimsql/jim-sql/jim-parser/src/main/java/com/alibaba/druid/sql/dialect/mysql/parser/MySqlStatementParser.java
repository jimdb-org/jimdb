...
//            Lexer.SavePoint savePoint = lexer.mark();
    ...
    public SQLStatement parseShow() {
        ...
        if (lexer.identifierEquals("TABLEINFOS")) {
            lexer.nextToken();

            SQLShowTablesInfoStatement stmt = parseShowTablessInfo();
            stmt.setFull(full);

            return stmt;
        }

        if (lexer.identifierEquals("DBINFOS")) {
            lexer.nextToken();

            MySqlShowDatabasesInfoStatement stmt = parseShowDatabasesInfo();
    ...
    private MySqlShowDatabasesInfoStatement parseShowDatabasesInfo() {
        MySqlShowDatabasesInfoStatement stmt = new MySqlShowDatabasesInfoStatement();
    ...
    private SQLShowTablesInfoStatement parseShowTablessInfo() {
        SQLShowTablesInfoStatement stmt = new SQLShowTablesInfoStatement();
