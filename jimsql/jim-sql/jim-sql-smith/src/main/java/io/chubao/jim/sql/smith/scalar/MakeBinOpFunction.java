 ...
 * @version V1.0
 */
public class MakeBinOpFunction extends MakeScalarFunction {

  public MakeBinOpFunction(Scalar scalar, int weight) {
    this.scalar = scalar;
    this.weight = weight;
  }
  ...
  public SQLExpr makeSQLExpr(Scope scope, Basepb.DataType dataType, Column[] columns) {
    ...
    SQLBinaryOperator sqlBinaryOperator = Scalar.randBinOps();
