...
public final class RoutePolicy {
  private static final Logger LOGGER = LoggerFactory.getLogger(RoutePolicy.class);

  //route cache
  private RouteCache cache;
  private long clusterId;

  public RoutePolicy(RouterStore routerStore, long clusterId, long dbId, long tableId) {
