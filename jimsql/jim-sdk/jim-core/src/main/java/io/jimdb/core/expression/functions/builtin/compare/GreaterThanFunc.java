...
public final class GreaterThanFunc extends Func {
  protected static final EnumMap<ValueType, Exprpb.ExprType> EXPRTYPE_MAP;

  static {
    EXPRTYPE_MAP = new EnumMap<>(ValueType.class);
    EXPRTYPE_MAP.put(ValueType.LONG, Exprpb.ExprType.GreaterInt);
    EXPRTYPE_MAP.put(ValueType.UNSIGNEDLONG, Exprpb.ExprType.GreaterInt);
    EXPRTYPE_MAP.put(ValueType.STRING, Exprpb.ExprType.GreaterString);
    EXPRTYPE_MAP.put(ValueType.DOUBLE, Exprpb.ExprType.GreaterReal);
    EXPRTYPE_MAP.put(ValueType.DECIMAL, Exprpb.ExprType.GreaterDecimal);
    EXPRTYPE_MAP.put(ValueType.DATE, Exprpb.ExprType.GreaterDate);
    EXPRTYPE_MAP.put(ValueType.TIME, Exprpb.ExprType.GreaterTime);
    EXPRTYPE_MAP.put(ValueType.YEAR, Exprpb.ExprType.GreaterInt);
  }

  private ExprComparator comparator;

  private GreaterThanFunc() {
  }

  protected GreaterThanFunc(Session session, Expression[] args, ValueType retTp, ValueType cmpTp) {
  ...
  @Override
  public GreaterThanFunc clone() {
    GreaterThanFunc result = new GreaterThanFunc();
    clone(result);
