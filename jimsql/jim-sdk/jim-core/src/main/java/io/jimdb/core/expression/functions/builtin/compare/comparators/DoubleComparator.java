 ...
 * @version V1.0
 */
public class DoubleComparator extends ExprComparator {
  static final DoubleComparator INSTANCE = new DoubleComparator();
  ...
  public LongValue compare(Session session, Expression expr1, ValueAccessor row1, Expression expr2,
    ...
    Value v1 = expr1.execDouble(session, row1);
    Value v2 = expr2.execDouble(session, row2);
