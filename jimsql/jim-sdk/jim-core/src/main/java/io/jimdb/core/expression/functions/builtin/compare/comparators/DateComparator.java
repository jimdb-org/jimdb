 ...
 * @version V1.0
 */
public class DateComparator extends ExprComparator {
  static final DateComparator INSTANCE = new DateComparator();
  ...
  public LongValue compare(Session session, Expression expr1, ValueAccessor row1, Expression expr2,
    ...
    DateValue value1 = expr1.execDate(session, row1);
    DateValue value2 = expr2.execDate(session, row2);
