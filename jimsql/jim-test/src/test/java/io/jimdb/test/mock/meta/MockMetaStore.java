...
public class MockMetaStore extends MockMeta {
  ...
  private Metapb.TableInfo initTable_user() {
    ...
    List<Integer> salaryColumns = new ArrayList<>();
    salaryColumns.add(5);

//    Metapb.IndexInfo salaryIndexInfo = Metapb.IndexInfo.newBuilder()
//            .setId(5)
//            .setName("idx_salary")
//            .addAllColumns(salaryColumns)
//            .setPrimary(false)
//            .setUnique(true)
//            .setType(Metapb.IndexType.BTree)
//            .setState(Metapb.MetaState.Public).build();
...
//    indexInfos.add(salaryIndexInfo);
