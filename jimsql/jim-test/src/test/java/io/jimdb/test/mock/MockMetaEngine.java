...
// * @version V1.0
// */
//public final class MockMetaEngine implements Engine {
...
//  }
//
//  static final class MockMetaData implements MetaEngine.MetaData {
...
//      List<JimTable> tables = new ArrayList<>();
//      tables.add(initTable_user());
//      tables.add(initTable_Person());
//      return tables.toArray(new JimTable[0]);
//    }
//
//    private JimTable initTable_user() {
...
//      JimColumn[] columns = new JimColumn[5];
...
//      table.setColumns(columns);
//
//      // table indices: idx_age, idx_phone, idx_age_phone, idx_salary
//      JimIndex[] indices = new JimIndex[4];
...
//      indices[2] = jimIndex2;
//
//      JimIndex jimIndex3 = new JimIndex();
//      jimIndex3.setId(4);
//      jimIndex3.setName("idx_salary");
//      jimIndex3.setColNames(new String[]{"salary"});
//      //jimIndex3.setUnique(true);
//      jimIndex3.setIndexType(Index.IndexType.Btree);
//      indices[3] = jimIndex3;
...
//
//
//    private JimTable[] initTables_bak() {
//      JimTable table = new JimTable();
//      table.setId(1);
//      table.setDbId(1);
//      table.setName("user");
...
//     * @return
//     */
//    private JimTable initTable_Person() {
//      JimTable table = new JimTable();
//      table.setId(1);
//      table.setDbId(1);
//      table.setDbName("test");
