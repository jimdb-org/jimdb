...
//using jimkv::sdk::kv::JimKVContext;
//using jimkv::sdk::kv::JimKVCommand;
//using jimkv::sdk::kv::JimTableClient;
//using jimkv::sdk::kv::KvCmdPtr;
//using jimkv::sdk::kv::KVReplyPtr;
//using jimkv::sdk::kv::TableClientPtr;
...
typedef struct jimkv_space_context {
    jimkv::sdk::kv::TableClientPtr table_client;
} space_context_t;
