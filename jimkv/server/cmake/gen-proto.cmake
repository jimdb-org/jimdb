...
foreach(PROTO_FILE ${proto_FILES})
    ...
    list(APPEND proto_DEPENDS ${PROJECT_SOURCE_DIR}/../../protocol/${PROTO_FILE})
endforeach()
...
add_custom_command(OUTPUT
    ...
    COMMAND cp -rf ${PROJECT_SOURCE_DIR}/../proto .
    COMMAND sed -i -E '/gogo/d' proto/*/*.proto
    COMMAND sed -i -E 's/github.com\\/jimdb-org\\/jimdb\\/jimkv\\/proto\\///' proto/*/*.proto
